...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ABSACUSTOMER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ABSACUSTOMERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ABSACUSTOMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ABSACUSTOMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ABSACUSTOMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ABSACUSTOMER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ABSACUSTOMER actions', async () => {
      const expectedActions = [
        {
