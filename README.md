# AbsaUGDTMicrosrvcCustomerAccountSvc
...
To build the final jar and optimize the AbsaUGDTMicrosrvcCustomerAccountSvc application for production, run:
...
Then navigate to [http://localhost:9065](http://localhost:9065) in your browser.
